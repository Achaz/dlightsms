...
@section('head')
    <title>Login - d.light - Admin Dashboard</title>
@endsection
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5">
                    ...
                    <span class="text-white text-lg ml-3">
                        d.light<span class="font-medium">Uganda</span>
                    </span>
                </a>
                <div class="my-auto">
                    <img alt="Midone Tailwind HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="{{ asset('dist/images/illustration.svg') }}">
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Welcome to the d.light <br> Sms platform.</div>
                    <div class="-intro-x mt-5 text-lg text-white dark:text-gray-500">Solar Home Systems & outdoor Solar lanterns</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-8">
                        <form id="login-form">
                            <input type="text" id="input-username" class="intro-x login__input input input--lg border border-gray-300 block" placeholder="Username" value="">
                            <div id="error-username" class="login__input-error w-5/6 text-theme-6 mt-2"></div>
                            <input type="password" id="input-password" class="intro-x login__input input input--lg border border-gray-300 block mt-4" placeholder="Password" value="">
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        <button id="btn-login" class="button w-24 rounded-full shadow-md mr-1 mb-2 bg-theme-1 text-white">Login</button>
    ...
    <script>
        cash(function () {
            async function login() {
                ...
                // Post form
                let username = cash('#input-username').val()
